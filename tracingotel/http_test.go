...
import (
	...
	. "knative.dev/pkg/tracingotel"
	"knative.dev/pkg/tracingotel/config"
)
...
func TestHTTPSpanMiddleware(t *testing.T) {
	...
	next := &testHandler{}
	// HTTPSpanMiddleware is from the "knative.dev/pkg/tracingotel" package
...
func TestHTTPSpanIgnoringPaths(t *testing.T) {
	...
	// HTTPSpanIgnoringPaths is from the "knative.dev/pkg/tracingotel" package
	// It has already been updated to use otelhttp.WithFilter
